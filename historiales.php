...
<head>
    ...
    <title>Historial de Ventas - IMAGEN UNIK</title>
...
<body>
    ...
    <div class="pos-container" style="display: block;">
        <div class="main-panel glass" style="margin-bottom: 1rem;">
            <h2>Historial de Ventas Confirmadas</h2>
            ...
            <div class="filter-panel">
                ...
                <button class="btn btn-primary" onclick="loadSales()">Buscar</button>
            </div>
    ...
    <div class="modal-overlay" id="sale-modal">
        <div class="modal-content" style="padding: 0; display: flex; flex-direction: column;">
            <div class="modal-header" style="padding: 1.5rem 2rem; border-bottom: 1px solid #eee; margin: 0; background: #f8f9fa; border-radius: var(--radius) var(--radius) 0 0;">
                <h3 style="margin: 0; color: #333;">📄 Detalle de Venta</h3>
            ...
            <div id="printable-area" style="padding: 2rem; overflow-y: auto; max-height: 60vh;">
                <div class="print-header">
                    ...
                    <h2 style="margin-top: 1rem;">Nota de Venta #<span id="print-id"></span></h2>
            ...
            <div class="modal-footer" style="padding: 1.5rem 2rem; border-top: 1px solid #eee; background: #f8f9fa; border-radius: 0 0 var(--radius) var(--radius); display: flex; gap: 1rem; justify-content: flex-end;">
                ...
                <button class="btn btn-success" onclick="printSale()">🖨️ Imprimir</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function loadSales() {
            ...
            fetch(`api/get_sales.php?start=${start}&end=${end}`)
                .then(res => res.json())
                .then(data => {
                    ...
                    if (data.success && data.data.length > 0) {
                        data.data.forEach(v => {
                            ...
                            tr.innerHTML = `
                                ...
                                <td><button class="btn btn-secondary" style="padding: 0.25rem 0.5rem; font-size: 0.8rem;" onclick="openSale(${v.id})">Ver e Imprimir</button></td>
                            `;
                            tbody.appendChild(tr);
                        });
                    } else {
                        tbody.innerHTML = '<tr><td colspan="5" style="text-align:center;">No se encontraron ventas en este rango de fechas.</td></tr>';
                    }
                })
